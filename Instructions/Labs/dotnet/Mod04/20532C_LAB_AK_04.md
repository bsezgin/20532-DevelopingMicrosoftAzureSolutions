...
> **Note:** It typically takes five to ten minutes for the publish process to complete. You can track the progress of your publish in the Microsoft Azure Activity Log (**View** &gt; **Other Windows** &gt; **Microsoft Azure Activity Log**) pane that displays when you publish your Web App project.
...
7.  Open the **View** menu and then select the **SQL Server object Explorer** option. (After adding Azure SQL to the Management Studio)
...
15. Right click **Events** table, and then select **View Data**.
