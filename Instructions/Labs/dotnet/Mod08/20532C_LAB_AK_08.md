...
1.  In the navigation pane on the left side of the screen, scroll down, and then click **Create a Resource** and type **Service Bus**


1. Click the **Create** button and perform the following steps:

  a. In the **Name** box, type **sb20532[*Your Name*]**.

  b. In the **Pricing Tier** list, select the **Standard** option.

  c. In the **Location** list, select the region that is closest to your location.

  d. Click the **Create** button to create your namespace.
...
1. In the blade that appears, click **Shared access policies**.

1. Click the *RootManageSharedAccessKey*.

1. Record the *Primary Connections String* connection string from the **SAS Policy** blade.

  > **Note:** This connection string will be used in various parts of this lab.

1. Close the **SAS Policy** blade.

1. At the left of the blade, click **Queues**.

1. At the top of the blade, click **Queue**.

1. In the **Create Queue** dialog box, perform the following steps:

  a. In the **Name** box, type **signin**.

  b. Leave all fields as their default values.

  c. Click the check mark button to create the new queue.
